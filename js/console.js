    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "LCPC Snake<p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. " + fullScreenText + "<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "LCPC Snake<p></p>You died :(.<p></p>";
